...
gobindata:
	go generate github.com/ben1009/truss/gengokit/template

# Install truss
truss: gobindata
	go install -ldflags '-X "main.version=$(SHA)" -X "main.date=$(VERSION_DATE)"' github.com/ben1009/truss/cmd/truss
