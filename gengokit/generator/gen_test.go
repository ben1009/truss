...
import (
	...
	templateFileAssets "github.com/ben1009/truss/gengokit/template"
...
func TestTemplatePathToActual(t *testing.T) {
	pathToWants := map[string]string{
		...
		"NAMEservice/test.gotemplate": "NAMEservice/test.go",
		"NAMEservice/server":          "NAMEservice/server",
	}
...
func TestApplyTemplateFromPath(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/ben1009/truss",
		PBPackage: "github.com/ben1009/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/ben1009/truss/gengokit",
		PBPackage: "github.com/ben1009/truss/gengokit/generalservice",
	}
