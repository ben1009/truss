...
import (
	...
	helper "github.com/ben1009/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/ben1009/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/ben1009/truss/gengokit/general-service"
		)
