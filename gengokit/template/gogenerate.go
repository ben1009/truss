//go:generate go-bindata -mode 0644 -modtime 1464111000 -o template.go -pkg template -ignore swp -prefix NAMEservice/ NAMEservice/...
...
/*
	...
	stored in ./NAMEservice. This binary date is stored in template.go
