...
func svcClientGrpcClientGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/client/grpc/client.gotemplate", size: 3960, mode: os.FileMode(420), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
